...
BUTTONS = {
          ...
          "Weapon_Buttons": {"ak47": M.create_button("ak47", v2(140, 240), M.get_image_outline(AM.assets["ak47"]), {"text_pos": "left", "on": True, "active": True, "axisl": "min", "axis": "x"}),
                             "shotgun": M.create_button("shotgun", v2(140, 215), M.get_image_outline(AM.assets["shotgun"]), {"text_pos": "left", "active": True, "axisl": "min", "axis": "x"}),
                             "minigun": M.create_button("minigun", v2(140, 180), M.get_image_outline(AM.assets["minigun"]), {"text_pos": "left", "active": True, "axisl": "min", "axis": "x"}), },
          "Menu_Buttons": {"play": M.create_button("play", v2(200, 240), AM.assets["button5"], {"active": True}),
                           ...
                           "medium": M.create_button("medium", v2(100, 30), AM.assets["button5"], {"on": True, "active": True, "axisl": "min"}),
                           "hard": M.create_button("hard", v2(150, 30), AM.assets["button5"], {"active": True, "axisl": "min"})},
