...
border = load_image("Assets/Backgrounds/border.png", REN_RES)
...
Player_Running = import_SpriteSheet("Assets/Entities/Player/AnimationSheet_Character.png", 0, 98, 32, 32, 8, PLAYER_RES, (0, 0, 0))
Enemy_idle = cached_import_gif("Assets/Entities/Enemy1", ENEMY_RES)
Main_Border_Image = load_image("Assets/Backgrounds/Foundation/043.png", None, (255, 255, 255))
Border_Animation_Images = cached_import_gif("Assets/Backgrounds/New_Border")
...
Rifle = load_image("Assets/Objects/Weapons/rifle.png", None, (0, 0, 0))
Rifle_bullet = load_image("Assets/Objects/Bullet/Bullet 1/Bullet.png")
