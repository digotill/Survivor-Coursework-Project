...
class GameVariables:
          ...
          def update(self):
                    ...
                    self.game.mouse_pos = (max(0, min(pygame.mouse.get_pos()[0], self.game.display.width)), max(0, min(pygame.mouse.get_pos()[1], self.game.display.height)))
                    self.game.correct_mouse_pos = (int(self.game.mouse_pos[0] * REN_RES[0] / self.game.display.width), int(self.game.mouse_pos[1] * REN_RES[1] / self.game.display.height))
